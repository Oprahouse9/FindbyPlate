...
if ans=="VIN":
   ...
   for tag2 in tag2:
     ...
     time.sleep(1)
     plate2 = input(Style.BRIGHT + Fore.RED + "[+] plate: ")
     print("[bold blue]now type the [/bold blue][bold yellow]State[/bold yellow][bold blue] for the given plate [/bold blue][bold red]"+plate2+"[/bold red]")
     sleep(1)
...
WY - wyoming
     ...
     print("[bold blue]+-------------------------------------------------------+[/bold blue]")
     print("[dim cyan]INFO: [/dim cyan][bold red]"+plate2+" "+state+"[/bold red]")
     print("[bold blue]+-------------------------------------------------------+[/bold blue]")
     sleep(0.1)
     url2 = 'https://findbyplate.com/US/'+state+'/'+plate2+'/'
     ...
     sleep(1)
     print("[bold blue]using the plate lookup tool [/bold blue][bold yellow]FindbyPlate[/bold yellow] [bold blue]to lookup[/bold blue] [bold red]"+plate2+"[/bold red]")
     sleep(0.2)
     for _ in tqdm(range(100),
